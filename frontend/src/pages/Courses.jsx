...
const Courses = () => {
  ...
  if (loading)
    return <Loading message="Finding your next career-defining course..." />;
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 animate-fade-in">
          <h1 className="text-4xl md:text-5xl font-extrabold text-secondary-900 mb-6 tracking-tight">
            ...
            <span className="text-primary-600">Real-World Industry Needs</span>
          </h1>
          <p className="text-secondary-500 text-lg leading-relaxed">
            Every program focuses on hands-on training, project experience, and
            real-world execution—so learners gain skills they can actually
            apply.
          </p>
        </div>
