    ...
    <div className="min-h-screen bg-site-bg py-12 px-4">
      <div className="max-w-4xl mx-auto bg-site-surface rounded-xl shadow-lg p-8 border border-secondary-100">
        ...
        <div className="space-y-6 text-secondary-700">
          ...
          <section>
            <h2 className="text-2xl font-bold text-secondary-900 mb-3">3. Information Sharing</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-secondary-900 mb-3">4. Data Security</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-secondary-900 mb-3">5. Contact Us</h2>
            <p>
