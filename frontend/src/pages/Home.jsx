...
// Professional Refined SVG Icons - Memoized to prevent re-renders on mousemove
const Icons = {
  Expert: memo(() => (
    <svg
      className="w-8 h-8 group-hover:scale-110 group-hover:rotate-3 transition-transform duration-500"
      viewBox="0 0 24 24"
      fill="none"
  ...
  Assistance: memo(() => (
    ...
    >
      <path
        d="M16 7V19C16 20.66 14.66 22 13 22H11C9.34 22 8 20.66 8 19V7"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <path
        d="M12 2C13.66 2 15 3.34 15 5V7H9V5C9 3.34 10.34 2 12 2Z"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
  ...
  Mentorship: memo(() => (
    <svg
      className="w-8 h-8 group-hover:bounce transition-transform duration-500"
      viewBox="0 0 24 24"
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
    >
      <path
        d="M12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2C6.47715 2 2 6.47715 2 12C2 13.5997 2.37562 15.1116 3.04346 16.4525L2.58188 21.2326C2.47952 21.8213 3.00133 22.3333 3.58852 22.2198L7.12741 21.5358"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
  ...
  Access: memo(() => (
    ...
    >
      <path
        d="M7 21V10C7 6.69 9.69 4 13 4C16.31 4 19 6.69 19 10V21"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
...
const STATS = [
  { label: "Active Learners", value: "40+" },
  { label: "Elite Modules", value: "20+" },
  { label: "Senior Leads", value: "25+" },
  { label: "Internship", value: "90%" },
];
...
const TESTIMONIALS = [
  {
    name: "Sachin",
    role: "Cloud Engineer",
    brand: "Zippy Digital Solutions",
    theme: "dark",
    skill: "Cloud Engineering",
    color: "bg-gradient-to-br from-blue-600 to-cyan-500",
    text: "The hands-on approach made a real difference. The focus was not just on cloud concepts, but on deploying, managing, and troubleshooting real-world infrastructure. The projects gave me confidence to work with production-level systems.",
  },
  {
    name: "Selva Dhanush",
    ...
    text: "This program emphasized practical backend design, not just code. From API structure to authentication and scalability, the training helped me understand how real backend systems are built and maintained.",
  },
  {
    name: "Sanjai",
    role: "Backend Developer",
    ...
    text: "What stood out was the clarity in system-level thinking. Instead of isolated examples, we worked on complete backend workflows, which helped me strengthen my fundamentals and real-world problem-solving skills.",
  },
  {
    name: "Kaviraja",
    ...
    text: "The learning experience went beyond UI basics. I learned how to structure frontend applications, improve performance, and build interfaces that are both functional and user-friendly.",
  },
  {
    name: "John",
    ...
    text: "The program connected design with real business needs. It wasn’t just about visuals, but about creating designs that communicate clearly and support branding and user engagement.",
  },
  {
    name: "Balaji",
    role: "App Developer",
    ...
    text: "The project-based learning helped me understand the complete app lifecycle. From planning to deployment, the training gave me practical exposure that reflects real industry expectations.",
  },
];
...
const Home = () => {
  ...
  return (
    <div className="bg-site-bg min-h-screen selection:bg-indigo-100 selection:text-indigo-900 font-sans relative overflow-x-hidden">
      ...
      <div
        className="fixed inset-0 pointer-events-none z-[9999] opacity-[0.012] mix-blend-multiply"
        style={{
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 w-full">
          <div className="flex flex-col items-center text-center">
            <h1 className="text-6xl sm:text-8xl lg:text-[10rem] font-bold text-secondary-900 leading-[0.82] tracking-[-0.04em] mb-12 animate-fade-in max-w-7xl">
              Zippy <br className="hidden md:block" />
              <span className="text-primary-600">Digital Academy</span>
            </h1>
            ...
            <p className="max-w-2xl text-lg md:text-xl text-secondary-600 mb-16 animate-fade-in [animation-delay:200ms] leading-relaxed font-normal">
              Practical education for those building real digital products. Skip
              empty theory. Learn through real projects, guided internships, and
              hands-on execution—so you don’t just study tech, you use it.
            </p>

            <div className="flex flex-col sm:flex-row items-center gap-8 animate-fade-in [animation-delay:400ms]">
              <Link
                to="/courses"
                className="bg-primary-600 text-white px-16 py-6 rounded-2xl font-bold text-lg hover:bg-primary-700 transition-all shadow-2xl shadow-primary-200/50 hover:scale-[1.02] active:scale-95"
              >
                Launch Catalog
              </Link>
              <Link
                to="/methodology"
                className="flex items-center space-x-3 text-secondary-600 font-bold text-lg hover:text-primary-600 transition-colors py-2 group"
              >
                <span className="border-b-2 border-transparent group-hover:border-primary-600 transition-all">
                  The Methodology
                </span>
            ...
            {/* Minimalist Buffer */}
            <div className="mt-40 w-full animate-fade-in [animation-delay:600ms]"></div>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-12 md:gap-20">
            {STATS.map((stat, idx) => (
              <div key={idx} className="group">
                ...
                <div className="text-[10px] font-bold text-secondary-400 uppercase tracking-[0.4em] group-hover:text-primary-400 transition-colors">
                  {stat.label}
                </div>
              </div>
            ))}
      ...
      <section id="features" className="py-32 bg-transparent">
        <div className="max-w-7xl mx-auto px-6">
          <div className="mb-24">
            <h2 className="text-4xl md:text-6xl font-black text-secondary-900 mb-8 tracking-tighter leading-none">
              Structured for <br />
              Peak Results.
            </h2>
            <p className="text-secondary-600 text-xl font-normal leading-relaxed max-w-3xl">
              We design pedagogies that simulate the intensity of high-growth
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8 auto-rows-[320px] md:auto-rows-[360px]">
            ...
            <div className="md:col-span-8 bg-[#1B4B4E] p-12 rounded-[3.5rem] flex flex-col justify-between text-white relative overflow-hidden group shadow-2xl shadow-secondary-100/50">
              <div className="relative z-10">
                ...
                <h3 className="text-4xl md:text-5xl font-bold mb-6 tracking-tight leading-none">
                  Direct Access <br />
                  to the Engineers.
                </h3>
                <p className="text-secondary-100 text-xl font-normal max-w-md">
                  Learn from architects and seniors building the world's most
                  performant systems.
                </p>
              </div>
            ...
            <div className="md:col-span-4 bg-white border border-secondary-100 p-12 rounded-[3.5rem] flex flex-col justify-between group hover:border-primary-500/20 hover:shadow-2xl transition-all duration-500">
              ...
              <div>
                <h3 className="text-3xl font-bold text-secondary-900 mb-4 tracking-tighter">
                  Proof of Work.
                </h3>
                <p className="text-secondary-600 text-base font-normal leading-relaxed">
                  Build industry-grade products for your portfolio and get
                  verified.
                </p>
              </div>
            </div>
            ...
            <div className="md:col-span-4 bg-secondary-900 p-12 rounded-[3.5rem] flex flex-col justify-between text-white group relative overflow-hidden shadow-2xl">
              ...
              <div className="relative z-10">
                <h3 className="text-3xl font-bold mb-4 tracking-tighter leading-tight">
                  Infinite <br />
                  Access.
                </h3>
                <p className="text-secondary-300 text-base font-normal leading-relaxed">
                  Lifetime updates to all modules and an alumni network of 50k+
                  leads.
                </p>
              </div>
            ...
            <div className="md:col-span-8 bg-white p-12 rounded-[3.5rem] flex flex-col md:flex-row gap-12 items-center justify-between overflow-hidden group border border-secondary-100/50 hover:shadow-xl transition-all duration-500">
              <div className="max-w-xs shrink-0">
                ...
                <p className="text-secondary-600 text-base font-normal leading-relaxed">
                  Dedicated coaches and internal hiring lanes at top engineering
                  firms.
                </p>
              </div>
              ...
              <div className="w-full bg-slate-50 flex-grow rounded-[2.5rem] p-10 shadow-inner border border-secondary-50 relative overflow-hidden flex flex-col justify-center">
                <div className="flex items-center justify-between mb-8">
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="text-[10px] font-black text-secondary-400 uppercase tracking-[0.3em]">
                      Career Readiness
                    </span>
                  </div>
                  <div className="px-3 py-1 bg-white rounded-full border border-secondary-100 shadow-sm">
                ...
                <div className="space-y-6">
                  <div>
                    <div className="text-[10px] font-black text-primary-500 uppercase tracking-widest mb-2 leading-none">
                      Active Milestone
                    </div>
                    <div className="text-base font-bold text-secondary-900 tracking-tight leading-tight">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="h-4 w-full bg-secondary-100/50 rounded-full overflow-hidden p-1 shadow-inner relative">
                      <div className="h-full w-[88%] bg-primary-600 rounded-full shadow-lg shadow-primary-200/50 relative overflow-hidden">
                  ...
                  <div className="flex items-center justify-between pt-4 border-t border-secondary-100/50">
                    <div className="flex items-center space-x-3">
                      <div className="w-7 h-7 rounded-full bg-secondary-900 flex items-center justify-center text-[10px] text-white font-black border-2 border-white shadow-sm overflow-hidden">
                        <img
                          src="https://ui-avatars.com/api/?name=Alex+Miller&background=020617&color=fff"
                          alt="Mentor"
                          className="w-full h-full object-cover"
                        />
                      </div>
                      <div className="flex flex-col">
                        <span className="text-[10px] font-bold text-secondary-900 leading-none mb-1">
                          Alex Miller (Senior Lead)
                        </span>
        ...
        {TESTIMONIALS.map((t, idx) => (
          <div key={idx} className="break-inside-avoid group relative">
            <div className="p-10 bg-white/60 backdrop-blur-xl border border-secondary-100 rounded-[3rem] shadow-xl shadow-secondary-900/5 hover:bg-white hover:border-primary-500/20 transition-all duration-500 relative overflow-hidden">
              ...
              <div className="text-5xl text-primary-200 font-serif leading-none mb-8 group-hover:text-primary-400 transition-colors">
                “
              </div>
              ...
              <div className="pt-8 border-t border-secondary-50 flex items-center justify-between">
                <div className="flex items-center space-x-4">
                  <div
                    className={`w-12 h-12 ${t.color} rounded-2xl flex items-center justify-center font-black text-white text-base shadow-lg group-hover:scale-110 transition-transform`}
                  >
                    {t.name[0]}
                  </div>
                  <div>
                    <div className="font-bold text-secondary-900 text-sm tracking-tight">
                      {t.name}
                    </div>
                    <div className="text-[10px] font-bold text-primary-500 uppercase tracking-widest mt-1 leading-none">
                      {t.role}
                    </div>
                  </div>
                </div>
                <div className="flex flex-col items-end">
                  <div className="text-[10px] font-black text-secondary-200 tracking-tighter group-hover:text-secondary-900 transition-colors leading-none mb-1">
                    {t.brand}
                  </div>
          ...
          <div className="relative group rounded-[4rem] bg-secondary-950 p-12 md:p-32 text-center text-white shadow-3xl shadow-secondary-900/40 overflow-hidden border border-white/5">
            ...
            <div className="relative z-10">
              <div className="inline-flex items-center space-x-3 px-6 py-2 bg-white/5 border border-white/10 rounded-full mb-12 backdrop-blur-md">
                ...
                <span className="text-[10px] font-black text-primary-400 uppercase tracking-[0.4em]">
              ...
              <h2 className="text-6xl md:text-[9rem] font-black mb-12 tracking-tighter leading-[0.8] animate-fade-in">
                Secure Your <br />
                <span className="bg-gradient-to-r from-primary-400 via-primary-200 to-primary-400 bg-clip-text text-transparent">
                  Velocity.
                </span>
              </h2>
              ...
              <p className="text-secondary-200 text-xl md:text-2xl mb-20 max-w-2xl mx-auto font-normal opacity-70 leading-relaxed tracking-tight">
                Join the exclusive cohort of 50,000+ professionals who benchmark
                their growth against global engineering standards.
              </p>
                ...
                <div className="flex flex-col items-center lg:items-start text-center lg:text-left">
                  <div className="flex -space-x-3 mb-4">
                    {[
                      ...
                      <div
                        key={i}
                        className={`w-11 h-11 rounded-full border-4 border-secondary-950 ${color} shadow-lg`}
                      />
                    ))}
                  </div>
                  <div className="flex items-center space-x-3">
